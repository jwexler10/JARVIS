# test_speaker_id.py
import os
from audio_input import re        elif choice == "3":
            break
        else:
...
enc = VoiceEncoder()  
# Generate a random “audio” vector to test embedding shape
dummy = np.random.randn(22050*2)  # ~2 seconds of fake 22kHz audio
emb = enc.embed_utterance(dummy)
